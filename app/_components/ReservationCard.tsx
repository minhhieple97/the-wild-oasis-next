      ...
      <div className="flex flex-grow flex-col px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          {isPast(new Date(startDate)) ? (
            <span className="bg-yellow-800 text-yellow-200 flex h-7 items-center rounded-sm px-3 text-xs font-bold uppercase">
              past
            </span>
          ) : (
            <span className="bg-green-800 text-green-200 flex h-7 items-center rounded-sm px-3 text-xs font-bold uppercase">
              upcoming
            </span>
          )}
        </div>
